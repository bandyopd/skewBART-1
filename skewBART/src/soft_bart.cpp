...
void Forest::IterateGibbs(arma::vec& Y_hat,
                          const arma::mat& X,
                          const arma::vec& Y) {
...
arma::mat Forest::do_gibbs(const arma::mat& X,
                           const arma::vec& Y,
                           const arma::mat& X_test,
                           int num_iter) {
...
arma::vec Forest::predict_vec(const arma::mat& X_test) {
...
RCPP_MODULE(mod_forest) {
  ...
  class_<Forest>("Forest")
    ...
    .method("predict", &Forest::predict_vec)
